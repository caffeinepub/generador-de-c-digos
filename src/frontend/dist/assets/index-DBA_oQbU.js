...
const FileDown = createLucideIcon("file-down", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const WELCOME_MSG = "¡Hola! Soy tu asistente de producción 🤖. Puedes preguntarme cosas como: ¿por qué placa me quedé?, ¿qué pedidos tengo activos?, ¿cuánto hice hoy? También puedo generar PDFs si me lo pides.";
function ChatPage({ historial, pedidos }) {
  var _a2;
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Pregúntame sobre códigos, pedidos, historial o genera PDFs" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
...
function ManualPrintPage({
  ...
  const [fecha, setFecha] = reactExports.useState(todayStr());
...
function Orders({
  ...
  function handleAddCama(order) {
    ...
    const entry = {
      ...
      hora,
      tipo: tipoEntry,
      nombre: order.tipo !== "matriculas" ? `${TIPO_LABELS[order.tipo ?? "matriculas"]} — ${order.nombre}` : `${order.nombre}`,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["matriculas", "placas", "advertencia"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    style: {
                      background: modalTipo === t ? TIPO_COLORS[t].bg : "oklch(0.175 0.038 242)",
                      color: modalTipo === t ? TIPO_COLORS[t].text : "oklch(0.72 0.038 236)",
                      border: modalTipo === t ? `1px solid ${TIPO_COLORS[t].text}` : "1px solid rgba(255,255,255,0.08)"
                    },
                    children: TIPO_LABELS[t]
                  },
                  t
                )) })
              ] }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                      ...
                      order.tipo && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: TIPO_LABELS[order.tipo]
                        }
                      ),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
          ...
          "header",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between max-w-[1400px] mx-auto", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-1", "aria-label": "Páginas", children: tabs.map((tab) => {
                ...
                const accentColor = isChat ? "oklch(0.696 0.17 162.48)" : isTutorial ? "oklch(0.8 0.12 270)" : "oklch(0.828 0.167 87)";
                const accentBg = isChat ? "oklch(0.696 0.17 162.48 / 0.12)" : isTutorial ? "oklch(0.7 0.15 270 / 0.12)" : "oklch(0.828 0.167 87 / 0.12)";
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
        ...
        ) : activePage === "chat" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChatPage, { historial, pedidos: orders }) : /* @__PURE__ */ jsxRuntimeExports.jsx(TutorialPage, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "footer",
          {
