...
function renderBarcodeToCanvas(canvas, code, config) {
  return new Promise((resolve, reject) => {
    try {
...
function BarcodePreview({ config, code }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "canvas",
    {
      ref: canvasRef,
      width: 566,
...
function buildCode$3(prefix2, num, digits) {
  return prefix2 + String(num).padStart(digits, "0");
}
...
function BatchSystem({
  ...
  const [imgsPerLote, setImgsPerLote] = reactExports.useState(30);
  const [codigoInicioInput, setCodigoInicioInput] = reactExports.useState("");
  const [cantidadMatriculas, setCantidadMatriculas] = reactExports.useState("");
  const [progress, setProgress] = reactExports.useState("");
  const [generating, setGenerating] = reactExports.useState(false);
  const [addPrompt, setAddPrompt] = reactExports.useState(null);
  const savedLastCode = localStorage.getItem(LAST_CODE_KEY) || "";
  const effectiveStartCode = codigoInicioInput.trim() !== "" ? codigoInicioInput.trim() : config.codigoBase;
  const computedEndCode = (() => {
    const qty = Number.parseInt(cantidadMatriculas, 10);
    if (!cantidadMatriculas.trim() || Number.isNaN(qty) || qty <= 0)
      return null;
    const { prefix: prefix2, num, digits } = parseCode$3(effectiveStartCode);
    return buildCode$3(prefix2, num + qty - 1, digits);
  })();
  const useQuantityMode = computedEndCode !== null && cantidadMatriculas.trim() !== "" && Number.parseInt(cantidadMatriculas, 10) > 0;
  const handleContinuar = reactExports.useCallback(() => {
    if (!savedLastCode) return;
    const { prefix: prefix2, num, digits } = parseCode$3(savedLastCode);
    const nextCode = buildCode$3(prefix2, num + 1, digits);
  ...
  async function handleGenerate() {
    ...
    try {
      const zip = new JSZip();
      const { prefix: prefix2, num: startNum, digits } = parseCode$3(effectiveStartCode);
      ...
      if (useQuantityMode) {
        ...
        while (remaining > 0) {
          ...
          for (let i = 0; i < batchSize; i++) {
            const code = buildCode$3(prefix2, currentNum, digits);
      ...
      const lotesGenerados = useQuantityMode ? Math.ceil(Number.parseInt(cantidadMatriculas, 10) / imgsPerLote) : 1;
      onHistorialAdd({
        id: Date.now().toString(),
        fecha: (/* @__PURE__ */ new Date()).toLocaleString(),
  ...
  const inputCls = "bg-background/40 border border-white/15 rounded-lg px-3 py-1.5 text-foreground text-sm font-mono focus:outline-none focus:ring-1 focus:ring-primary placeholder:text-muted-foreground/50";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "rounded-2xl p-5 shadow-card",
      style: {
        background: "linear-gradient(135deg, oklch(0.215 0.042 240), oklch(0.245 0.048 240))",
        border: "1px solid rgba(255,255,255,0.08)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4", children: "Generar Matrículas" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground block mb-1.5", children: "Código de inicio" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            ...
            savedLastCode && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
          ...
          savedLastCode && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground/70 mt-1", children: [
            "Último código:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-foreground/80", children: savedLastCode })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Matrículas a generar" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Matrículas por lote" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
        ...
        useQuantityMode && computedEndCode && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground block mb-0.5", children: "Secuencia" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            style: {
              background: generating ? "oklch(0.652 0.048 236)" : "oklch(0.828 0.167 87)",
            ...
            children: generating ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              useQuantityMode ? `Generar ${cantidadMatriculas} matrículas` : `Generar ${imgsPerLote} matrículas`
            ] })
          }
        ),
        addPrompt && orders.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 14, style: { color: "oklch(0.828 0.167 87)" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "select",
                  {
                    ...
                    onChange: (e) => setAddPrompt(
                      (p) => p ? { ...p, selectedOrderId: e.target.value } : null
                    ),
                    ...
                    children: orders.map((o) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: o.id, children: [
                      o.nombre,
                      " (",
                      o.hecho,
                      "/",
...
function buildCode$2(prefix2, num, digits) {
  return prefix2 + String(num).padStart(digits, "0");
}
function generateBarcodePdfFromEntry(entry) {
  const { prefix: prefix2, num: startNum, digits } = parseCode$2(entry.codigoInicio);
  const codes = [];
  for (let i = 0; i < entry.totalImagenes; i++) {
    codes.push(buildCode$2(prefix2, startNum + i, digits));
  }
  ...
  const items = codes.map(
    (c) => `<div class="bi"><svg class="bc" data-code="${c}"></svg><p class="cl">${c}</p></div>`
  ).join("");
...
function generateSinCodigoPdfFromEntry(entry) {
...
</head><body><h1>Placas sin código — Resumen</h1><p class="sub">Generado el ${(/* @__PURE__ */ new Date()).toLocaleString("es")}</p>
...
function generateResumenPdf(historial, pedidos, semana, objetivo, lastCode) {
  ...
  const orderRows = pedidos.map(
    (o) => `<tr><td>${o.nombre}</td><td>${o.tipo}</td><td>${o.hecho}</td><td>${o.total}</td><td>${o.total - o.hecho}</td><td>${Math.round(o.hecho / o.total * 100)}%</td></tr>`
  ).join("");
...
<h1>Resumen de Producción</h1><p class="sub">Generado el ${(/* @__PURE__ */ new Date()).toLocaleString("es")}</p>
<div class="stats">
...
function parsePdfSegments(text, historial) {
  const norm = (s) => s.toLowerCase().normalize("NFD").replace(new RegExp("\\p{Diacritic}", "gu"), "");
  const msg = norm(text);
  const today = (/* @__PURE__ */ new Date()).toLocaleDateString("es-ES");
  const hasPdfKeyword = msg.includes("pdf") || msg.includes("descarga") || msg.includes("imprime") || msg.includes("imprimir") || msg.includes("descargar");
  if (!hasPdfKeyword) return [];
  const sinImagen = msg.includes("sin imagen") || msg.includes("sin imagenes") || msg.includes("sin fotos") || msg.includes("solo total") || msg.includes("solo datos");
  const stripped = msg.replace(
    ...
    ""
  ).replace(/\bsin\s+imagen(?:es)?\b/gi, "").replace(/\bsin\s+fotos?\b/gi, "").replace(/\bsolo\s+total(?:es)?\b/gi, "").replace(/\bsolo\s+datos?\b/gi, "").trim();
  ...
  for (const segText of segmentTexts) {
    ...
    if (segment.provider) {
      ...
      filtered = filtered.filter(
        (e) => e.nombre && norm(e.nombre).includes(p) || e.codigoInicio && norm(e.codigoInicio).includes(p) || e.codigoFin && norm(e.codigoFin).includes(p)
      );
    }
...
function splitIntoSegments(text) {
  ...
  for (let i = 1; i < parts.length; i++) {
    const part = parts[i];
    const partNorm = part.toLowerCase().normalize("NFD").replace(new RegExp("\\p{Diacritic}", "gu"), "");
    const startsNew = /^\d/.test(partNorm) || partNorm.startsWith("ultimas") || partNorm.startsWith("los ") || partNorm.startsWith("las ") || typeKeywords.some((k) => partNorm.startsWith(k));
    if (startsNew) {
...
function parseOneSegment(text) {
  const norm = (s) => s.toLowerCase().normalize("NFD").replace(new RegExp("\\p{Diacritic}", "gu"), "");
  const t = norm(text);
  const tOrig = text.trim();
  const onlyToday = t.includes("hoy") || t.includes("de hoy");
  let tipo = null;
  if (t.includes("placas ce") || t.includes("placa ce") || t.includes("placas sin codigo") || t.includes("placa sin codigo") || t.includes("sin codigo") || t.includes("sin barras")) {
    tipo = "sin-codigo";
  } else if (t.includes("matriculas") || t.includes("matricula") || t.includes("con codigo") || t.includes("con barras") || t.includes("barcode")) {
    tipo = "con-codigo";
  ...
  let remaining = tOrig.replace(/^(?:ultimas?\s+\d+|las?\s+\d+|los?\s+\d+|\d+)\s*/i, "").replace(/^(?:ultimas?|las?|los?)\s+/i, "").trim();
  ...
  if (provider) {
    provider = provider.replace(/\s+de\s+hoy\s*$/i, "").replace(/\s+hoy\s*$/i, "").trim();
    if (!provider) provider = null;
  }
  return { tipo, provider, limit, onlyToday, raw: text };
}
function generateFilteredPdf(segmentResults, summaryLabel, sinImagen = false) {
  const generatedAt = (/* @__PURE__ */ new Date()).toLocaleString("es");
  const globalSinImagen = sinImagen || segmentResults.some((r) => r.sinImagen === true);
  let allMatriculas = 0;
  let allPlacas = 0;
  let allTotal = 0;
  const sectionHtml = segmentResults.filter((r) => !r.notFound).map((r) => {
    const { segment, entries } = r;
    const tipoLabel = segment.tipo === "con-codigo" ? "Matrículas (con código de barras)" : segment.tipo === "sin-codigo" ? "Placas CE (sin código)" : segment.tipo === "advertencia" ? "Advertencia" : "Registros";
    ...
    const rows = entries.map((e) => {
      if (e.tipo === "con-codigo") {
        const codeCell = globalSinImagen ? `<code>${e.codigoInicio} → ${e.codigoFin}</code>` : `<code>${e.codigoInicio} → ${e.codigoFin}</code>`;
...
<table>
  ...
  const barcodeScript = !globalSinImagen && segmentResults.some((r) => !r.notFound && r.segment.tipo === "con-codigo") ? `<script src="https://cdn.jsdelivr.net/npm/jsbarcode@3.11.6/dist/JsBarcode.all.min.js"><\/script>` : "";
  const sinImagenNote = globalSinImagen ? `<p class="note">📄 PDF generado sin imágenes de códigos de barras (solo datos y totales)</p>` : "";
...
function extractSeriesPrefix(text) {
...
function findEntriesByPrefix(historial, prefix2) {
  const p = prefix2.toLowerCase();
  return historial.filter(
    (e) => {
      var _a2, _b2;
      return ((_a2 = e.codigoInicio) == null ? void 0 : _a2.toLowerCase().startsWith(p)) || ((_b2 = e.codigoFin) == null ? void 0 : _b2.toLowerCase().startsWith(p));
    }
  );
}
function getLastCodeInSeries(entries) {
...
function parseAddEnviado(msg) {
  const normalized = msg.toLowerCase().normalize("NFD").replace(new RegExp("\\p{Diacritic}", "gu"), "");
  const isEnviado = normalized.includes("enviado") || normalized.includes("envio") || normalized.includes("pedido") && (normalized.includes("enviad") || normalized.includes("completa") || normalized.includes("termina") || normalized.includes("enviar") || normalized.includes("marca")) || normalized.includes("anadi") && normalized.includes("enviado") || normalized.includes("añad") && normalized.includes("enviado") || normalized.includes("registra") && normalized.includes("enviado") || normalized.includes("nuevo enviado");
  if (!isEnviado) return { detected: false };
  const qtyMatch = normalized.match(
    /(\d+)\s*(unidades?|piezas?|uds?|matriculas?|placas?)?/
  );
  const cantidad = qtyMatch ? Number.parseInt(qtyMatch[1], 10) : void 0;
  let tipo;
...
function buildBotResponse(userText, historial, pedidos) {
  var _a2;
  const msg = userText.toLowerCase().normalize("NFD").replace(new RegExp("\\p{Diacritic}", "gu"), "");
  const semana = getFromLS("semana", {
    week: "",
    hecho: 0
  });
  const objetivo = getFromLS("objetivo", 5e3);
  const lastCode = getFromLS("lastGeneratedCode", "");
  const today = (/* @__PURE__ */ new Date()).toLocaleDateString("es-ES");
...
• **Nombre:** ${enviado.nombre}
• **Cantidad:** ${(_a2 = enviado.cantidad) == null ? void 0 : _a2.toLocaleString("es")} unidades
...
Pulsa el botón para confirmarlo.`,
  ...
  const hasPdfKeyword = msg.includes("pdf") || msg.includes("descarga") || msg.includes("descargar") || msg.includes("imprime") || msg.includes("imprimir");
  const hasSinImagen = msg.includes("sin imagen") || msg.includes("sin imagenes") || msg.includes("sin fotos") || msg.includes("solo total") || msg.includes("solo datos");
  const hasFilterKeyword = msg.includes("placa") || msg.includes("matricula") || msg.includes("advertencia") || msg.includes("proveedor") || msg.includes("ultimas") || msg.includes("historial") || msg.includes("hacer") || msg.includes("hazme") || msg.includes("genera") || msg.includes("generar") || /\d+\s*(placa|matricula|advertencia)/.test(msg);
  if (hasPdfKeyword && (hasFilterKeyword || hasSinImagen)) {
    ...
    if (segmentResults.length > 0) {
      ...
      for (const r of segmentResults) {
        const tipoLabel = r.segment.tipo === "con-codigo" ? "matrículas" : r.segment.tipo === "sin-codigo" ? "placas CE" : r.segment.tipo === "advertencia" ? "advertencias" : "registros";
        const provLabel = r.segment.provider ? ` de **${r.segment.provider}**` : "";
   ...
   ¿Quieres buscar sin filtrar por proveedor "${provName}"?` : ""}`
      ...
      if (!hasResults) {
        const notFoundText2 = notFoundParts.join("\n");
        return {
...
Asegúrate de que los registros existen en el historial y que el nombre del proveedor coincide exactamente.`
      ...
      const notFoundText = notFoundParts.length > 0 ? `

${notFoundParts.join("\n")}` : "";
      const sinImagenNote = globalSinImagen ? "\n\n📄 *PDF sin imágenes de códigos de barras*" : "";
      const summaryLabel = segmentResults.filter((r) => !r.notFound).map((r) => {
        const tipoLabel = r.segment.tipo === "con-codigo" ? "Matrículas" : r.segment.tipo === "sin-codigo" ? "Placas CE" : r.segment.tipo === "advertencia" ? "Advertencia" : "Registros";
        return r.segment.provider ? `${tipoLabel} ${r.segment.provider}` : tipoLabel;
      }).join(" + ");
      return {
...
Pulsa el botón para abrir el PDF.`,
  ...
  const resumPdf = msg.includes("resumen") && (msg.includes("pdf") || msg.includes("descarga") || msg.includes("imprimir"));
  if (resumPdf) {
    return {
  ...
  const generalPdf = msg.includes("pdf") || msg.includes("descargar") || msg.includes("imprimir");
  if (generalPdf) {
    ...
    const list = historial.slice(0, 5).map(
      (e, i) => `• Registro ${i + 1}: ${e.fecha} — ${e.tipo === "sin-codigo" ? `${e.totalImagenes} placas${e.nombre ? ` (${e.nombre})` : ""}` : `${e.codigoInicio} → ${e.codigoFin}`}`
    ).join("\n");
    return {
...
...y ${historial.length - 5} más.` : ""}`
  ...
  const isSeriesQuery = seriesPrefix !== null && (msg.includes("matricula") || msg.includes("placa") || msg.includes("codigo") || msg.includes("serie") || msg.includes("quede") || msg.includes("quedé") || msg.includes("ultimo") || msg.includes("último") || msg.includes("donde") || msg.includes("dónde") || seriesPrefix.length >= 2);
...
Asegúrate de que el código de inicio o fin de los registros empiece por "${seriesPrefix}". Puedes pedir "resumen del historial" para ver todos los registros.`
    ...
    const entryList = matched.slice(0, 8).map(
      (e) => `• Reg. #${historial.indexOf(e) + 1}: ${e.fecha}${e.hora ? ` ${e.hora}` : ""} — ${e.codigoInicio} → **${e.codigoFin}** (${e.totalImagenes} uds.)${e.operario ? ` | ${e.operario}` : ""}`
    ).join("\n");
    return {
...
📍 Último código de la serie: **${lastCodeSeries ?? "—"}**`
  ...
  if (msg.includes("cuantas matriculas") || msg.includes("cuántas matriculas") || msg.includes("total matriculas") || msg.includes("matriculas") && msg.includes("hice") || msg.includes("cuantas placas") || msg.includes("cuántas placas") || msg.includes("total placas") || msg.includes("placas") && msg.includes("hice") || msg.includes("cuantas advertencias") || msg.includes("cuántas advertencias") || msg.includes("advertencia") && msg.includes("hice")) {
    if (historial.length === 0) {
      return {
        text: "El historial está vacío. No hay datos de producción todavía."
      };
    }
    const totalMatriculas = historial.filter((e) => e.tipo === "con-codigo").reduce((s, e) => s + e.totalImagenes, 0);
    const totalPlacas = historial.filter((e) => e.tipo === "sin-codigo").reduce((s, e) => s + e.totalImagenes, 0);
    const totalAll = historial.reduce((s, e) => s + e.totalImagenes, 0);
    return {
...
• 📦 **Total global:** ${totalAll.toLocaleString("es")} unidades`
  ...
  if (msg.includes("placa") || msg.includes("matricula") || msg.includes("quede") || msg.includes("quedé") || msg.includes("codigo") || msg.includes("último") || msg.includes("ultimo") || msg.includes("ultimo codigo")) {
    const totalAll = historial.reduce((s, e) => s + e.totalImagenes, 0);
    const todayTotal = historial.filter((e) => e.fecha === today).reduce((s, e) => s + e.totalImagenes, 0);
    if (!lastCode && historial.length === 0) {
      return {
        text: "Aún no has generado ningún código. Ve al Generador (página 1) para crear tu primer lote."
      };
    }
    let response = lastCode ? `El último código generado fue: **${lastCode}**` : "No hay un código de inicio registrado aún.";
    if (historial.length > 0) {
...
📊 Total producido hoy: **${todayTotal}** | Total histórico: **${totalAll.toLocaleString("es")}**`;
  ...
  if (msg.includes("pedido") || msg.includes("activo") || msg.includes("orden") || msg.includes("encargo")) {
    if (pedidos.length === 0) {
      return {
...
${lines.join("\n\n")}`
  ...
  if (msg.includes("historial") || msg.includes("registro") || msg.includes("impresion") || msg.includes("impresión") || msg.includes("registre") || msg.includes("registré") || msg.includes("resumen del historial") || msg.includes("todos los registros")) {
    if (historial.length === 0) {
      return {
    ...
    const isFullListing = msg.includes("resumen del historial") || msg.includes("todos los registros") || msg.includes("lista") || msg.includes("listado");
    const entries = isFullListing ? historial : historial.slice(0, 5);
    const entryList = entries.map(
      (e, i) => `• #${i + 1}: ${e.fecha}${e.hora ? ` ${e.hora}` : ""}${e.operario ? ` | ${e.operario}` : ""} — ${e.tipo === "sin-codigo" ? `${e.totalImagenes} placas${e.nombre ? ` (${e.nombre})` : ""}` : `${e.codigoInicio} → ${e.codigoFin} (${e.totalImagenes})`}`
    ).join("\n");
    const trailer = !isFullListing && historial.length > 5 ? `
...
${entryList}${trailer}`
  ...
  if (msg.includes("hoy") || msg.includes("today") || msg.includes("este dia")) {
    const todayEntries = historial.filter((e) => e.fecha === today);
    const totalHoy = todayEntries.reduce((s, e) => s + e.totalImagenes, 0);
    ...
    const detail = todayEntries.map(
      (e) => `• ${e.tipo === "sin-codigo" ? `${e.totalImagenes} placas${e.nombre ? ` (${e.nombre})` : ""}` : `${e.codigoInicio} → ${e.codigoFin} (${e.totalImagenes} uds.)`}${e.operario ? ` | ${e.operario}` : ""}`
    ).join("\n");
    return {
...
${detail}`
  ...
  if (msg.includes("semana") || msg.includes("objetivo") || msg.includes("meta") || msg.includes("progreso")) {
    const pct = objetivo > 0 ? Math.round(semana.hecho / objetivo * 100) : 0;
...
• Restante: **${rest.toLocaleString("es")}**`;
  ...
  if (msg.includes("ayuda") || msg.includes("help") || msg.includes("como") || msg.includes("cómo") || msg.includes("que hace") || msg.includes("qué hace") || msg.includes("que es") || msg.includes("para que")) {
    return {
  ...
  return text.split("\n").map((line) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      parts.map((part) => {
        ...
        return part.startsWith("**") && part.endsWith("**") ? /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "oklch(0.828 0.167 87)" }, children: part.slice(2, -2) }, partKey) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: part }, partKey);
      }),
...
const WELCOME_MSG = "¡Hola! Soy tu asistente de producción 🤖. Puedes preguntarme cosas como: ¿por qué matrícula de TAS me quedé?, ¿resumen del historial?, ¿cuántas matrículas hice?, ¿qué pedidos tengo activos? También puedo generar PDFs personalizados: «hazme un PDF de las últimas 12 placas CE de porcelanosa y las 30 matrículas de TAS».";
function AddEnviadoForm({ prefill, onConfirm }) {
  const [nombre, setNombre] = reactExports.useState((prefill == null ? void 0 : prefill.nombre) ?? "");
  const [cantidad, setCantidad] = reactExports.useState((prefill == null ? void 0 : prefill.cantidad) ?? 0);
  const [tipo, setTipo] = reactExports.useState(
    (prefill == null ? void 0 : prefill.tipo) ?? "matriculas"
  );
  ...
  if (submitted) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: "✅ ¡Pedido enviado registrado correctamente!"
      }
    );
  }
  function handleSubmit(e) {
    ...
    onConfirm({
      id: Date.now().toString(),
      fecha: now2.toLocaleDateString("es-ES"),
      hora: now2.toLocaleTimeString("es-ES", {
        hour: "2-digit",
        minute: "2-digit"
      }),
      nombre: nombre.trim(),
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "Nuevo pedido enviado"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1 col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Nombre *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Cantidad *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Tipo *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                value: tipo,
                ...
                style: { color: "#000", background: "#fff", borderColor: "#ccc" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "matriculas", children: "Matrículas" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "placas", children: "Placas CE" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "advertencia", children: "Advertencia" })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1 col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Notas (opcional)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: "Confirmar pedido enviado"
          }
        )
      ]
    }
...
function ChatPage({
  ...
  const [messages, setMessages] = reactExports.useState(() => {
    const saved = getFromLS("chatHistory", []);
  ...
  reactExports.useEffect(() => {
    try {
      const toSave = messages.map((m) => {
        var _a3;
        if (((_a3 = m.action) == null ? void 0 : _a3.type) === "pdf" && m.action.handler === "filtered") {
          const {
            filteredEntries: _fe,
            segmentResults: _sr,
            ...rest
  ...
  function handlePdfAction(action) {
    ...
    const objetivo = getFromLS("objetivo", 5e3);
    const lc = getFromLS("lastGeneratedCode", "");
    ...
    } else if (action.handler === "barcode_entry" && action.entryIndex !== void 0) {
      const entry = historial[action.entryIndex];
      if (entry) generateBarcodePdfFromEntry(entry);
    } else if (action.handler === "sincodigo_entry" && action.entryIndex !== void 0) {
      const entry = historial[action.entryIndex];
  ...
  function handleAddEnviado(p) {
    onAddPedidoEnviado == null ? void 0 : onAddPedidoEnviado(p);
    addMessage({
      role: "bot",
...
Puedes verlo en la página "Pedidos Enviados".`
  ...
  const cardBg2 = "linear-gradient(135deg, oklch(0.215 0.042 240), oklch(0.245 0.048 240))";
  const cardBorder2 = "1px solid rgba(255,255,255,0.08)";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: { background: cardBg2, border: cardBorder2 },
            children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h2",
                    {
                      ...
                      children: "Asistente de Producción"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Pregúntame sobre códigos, pedidos, historial · genera PDFs con filtros" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            msg.role === "bot" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground font-medium ml-1", children: "Asistente" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                            ...
                            ((_a3 = msg.action) == null ? void 0 : _a3.type) === "pdf" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "button",
                              {
                                type: "button",
                            ...
                            ((_b2 = msg.action) == null ? void 0 : _b2.type) === "add_enviado" && onAddPedidoEnviado && /* @__PURE__ */ jsxRuntimeExports.jsx(
                              AddEnviadoForm,
                              {
          ...
          "div",
          {
            ...
            children: QUICK_QUESTIONS.map((q) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                "data-ocid": `chat.quick_q.${q.replace(/[^a-z0-9]/gi, "_").toLowerCase().slice(0, 30)}`,
                children: q
              },
              q
            ))
...
function buildCode$1(prefix2, num, digits) {
  return prefix2 + String(num).padStart(digits, "0");
}
function generatePdfHtml(title, meta, codes) {
  const barcodeItems = codes.map(
    (code) => `<div class="barcode-item"><svg class="barcode" data-code="${code}"></svg><p class="code-label">${code}</p></div>`
  ).join("");
  return `<!DOCTYPE html>
<html lang="es">
<head>
...
function generateSinCodigoPdfHtml(entry) {
...
<body>
  ...
  <p class="subtitle">Generado el ${(/* @__PURE__ */ new Date()).toLocaleString("es")}</p>
  <div class="card">
...
function downloadBarcodePdf(entry, customStart, customEnd) {
  const startCode = (customStart == null ? void 0 : customStart.trim()) || entry.codigoInicio;
  const endCode = (customEnd == null ? void 0 : customEnd.trim()) || entry.codigoFin;
  const { prefix: prefix2, num: startNum, digits } = parseCode$1(startCode);
  const { num: endNum } = parseCode$1(endCode);
  ...
  for (let i = 0; i < count; i++) {
    codes.push(buildCode$1(prefix2, startNum + i, digits));
  }
  const meta = `Operario: ${entry.operario ?? "—"} | Desde: ${startCode} | Hasta: ${buildCode$1(prefix2, startNum + count - 1, digits)} | Total: ${count} códigos`;
...
function downloadSinCodigoPdf(entry) {
...
function downloadSelectedPdf(selectedEntries) {
  ...
  for (const { entry } of conCodigo) {
    const { prefix: prefix2, num: startNum, digits } = parseCode$1(entry.codigoInicio);
    for (let i = 0; i < entry.totalImagenes; i++) {
      allCodes.push(buildCode$1(prefix2, startNum + i, digits));
    }
  }
  ...
  const labels = selectedEntries.map(
    ({ num, entry }) => entry.tipo === "sin-codigo" ? `#${num} (${entry.totalImagenes} placas sin código${entry.nombre ? ` — ${entry.nombre}` : ""})` : `#${num} (${entry.codigoInicio}–${entry.codigoFin})`
  ).join(", ");
...
<body>
  ...
  <p class="subtitle">Generado el ${(/* @__PURE__ */ new Date()).toLocaleString("es")} | Selección: ${labels}</p>
  <table>
  ...
  if (sinCodigo.length > 0) {
    const rows = sinCodigo.map(
      ({ num, entry }) => `<tr><td>${num}</td><td>${entry.fecha}</td><td>${entry.operario ?? "—"}</td><td>${entry.nombre ?? "—"}</td><td>${entry.totalImagenes} placas sin código</td></tr>`
    ).join("");
    sinCodigoBlock = `
  ...
  const barcodeItems = allCodes.map(
    (code) => `<div class="barcode-item"><svg class="barcode" data-code="${code}"></svg><p class="code-label">${code}</p></div>`
  ).join("");
...
function HistorialPage({
  ...
  const [customRanges, setCustomRanges] = reactExports.useState({});
  ...
  function toggleExpanded(id, entry) {
  ...
  const selectedEntries = historial.map((e, i) => ({ entry: e, num: i + 1 })).filter(({ entry }) => selected.has(entry.id));
  const inputCls = "bg-background/40 border border-white/10 rounded-lg px-2 py-1 text-foreground text-xs font-mono focus:outline-none focus:ring-1 focus:ring-primary placeholder:text-muted-foreground/50";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                style: { color: "oklch(0.942 0.012 236)" },
                children: "Historial Completo de Impresiones"
              }
            ),
            historial.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "font-semibold",
                  style: { color: "oklch(0.828 0.167 87)" },
                  children: historial.length
                }
              ),
              " ",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "font-semibold",
                  style: { color: "oklch(0.828 0.167 87)" },
                  children: totalImagens.toLocaleString("es")
                }
              ),
              " ",
              "totales"
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Sin registros aún" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap justify-end", children: [
            ...
            historial.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                onClick: onClear,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: historial.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileDown, { size: 22, style: { color: "oklch(0.652 0.048 236)" } })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "No hay registros todavía." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs opacity-60", children: "Los registros aparecerán aquí tras generar lotes o registrar impresiones manualmente." })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", "data-ocid": "historial.table", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-white/10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2.5 px-2 w-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "checkbox",
                checked: historial.length > 0 && selected.size === historial.length,
                onChange: toggleAll,
                className: "rounded",
                title: "Seleccionar todos"
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center py-2.5 px-2 text-muted-foreground font-medium w-8", children: "#" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2.5 px-3 text-muted-foreground font-medium whitespace-nowrap", children: "Fecha" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2.5 px-3 text-muted-foreground font-medium whitespace-nowrap", children: "Hora" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2.5 px-3 text-muted-foreground font-medium whitespace-nowrap", children: "Operario" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2.5 px-3 text-muted-foreground font-medium whitespace-nowrap", children: "Tipo / Nombre" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2.5 px-3 text-muted-foreground font-medium whitespace-nowrap", children: "Cód. Inicio" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2.5 px-3 text-muted-foreground font-medium whitespace-nowrap", children: "Cód. Fin" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center py-2.5 px-3 text-muted-foreground font-medium whitespace-nowrap", children: "Lotes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center py-2.5 px-3 text-muted-foreground font-medium whitespace-nowrap", children: "Total" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right py-2.5 px-3 text-muted-foreground font-medium whitespace-nowrap", children: "Acciones" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: historial.map((entry, i) => {
            const rowNum = i + 1;
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "tr",
                {
                  ...
                  style: isSelected ? { background: "oklch(0.828 0.167 87 / 0.06)" } : {},
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-2 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: "inline-flex items-center justify-center w-5 h-5 rounded-full text-[10px] font-bold shrink-0",
                        style: {
                          background: isSelected ? "oklch(0.828 0.167 87)" : "oklch(0.295 0.052 240)",
                          color: isSelected ? "oklch(0.138 0.032 243)" : "oklch(0.652 0.048 236)"
                        },
                        children: rowNum
                      }
                    ) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-3 text-foreground whitespace-nowrap", children: entry.fecha }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-3 text-foreground whitespace-nowrap", children: entry.hora ?? "—" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-3 text-foreground", children: entry.operario ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: entry.operario
                      }
                    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "—" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium whitespace-nowrap w-fit",
                          style: {
                            background: sinCodigo ? "oklch(0.577 0.245 27.325 / 0.15)" : "oklch(0.696 0.17 162.48 / 0.15)",
                            color: sinCodigo ? "oklch(0.8 0.15 27)" : "oklch(0.696 0.17 162.48)"
                          },
                          children: sinCodigo ? "Sin código" : "Con código"
                        }
                      ),
                      sinCodigo && entry.nombre && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "td",
                      {
                        ...
                        style: { color: "oklch(0.828 0.167 87)" },
                        children: sinCodigo ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-sans", children: "—" }) : entry.codigoInicio
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "td",
                      {
                        className: "py-2.5 px-3 font-mono whitespace-nowrap",
                        style: { color: "oklch(0.828 0.167 87)" },
                        children: sinCodigo ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-sans", children: "—" }) : entry.codigoFin
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-3 text-center text-foreground", children: sinCodigo ? "—" : entry.lotes }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: entry.totalImagenes
                      }
                    ) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-1.5", children: [
                      sinCodigo ? (
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "button",
                          {
                            ...
                            style: {
                              background: isExpanded ? "oklch(0.652 0.048 236 / 0.25)" : "oklch(0.652 0.048 236 / 0.1)",
                              color: isExpanded ? "oklch(0.828 0.12 220)" : "oklch(0.652 0.048 236)"
                            },
              ...
              isExpanded && !sinCodigo && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-b border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 11, className: "px-4 pb-3 pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "rounded-xl p-3 flex flex-wrap items-end gap-3",
                  style: {
                    background: "oklch(0.175 0.038 241 / 0.8)",
                    border: "1px solid oklch(0.652 0.048 236 / 0.2)"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Código inicio" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          type: "text",
                          value: range.start,
                          onChange: (e) => setCustomRanges((prev) => ({
                            ...prev,
                            [entry.id]: {
                              ...range,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Código fin" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          type: "text",
...
function downloadAsPdf(historial) {
  const rows = historial.map((e) => {
    const sinCodigo = e.tipo === "sin-codigo";
    const tipoLabel = sinCodigo ? e.nombre ? `Placa sin código — ${e.nombre}` : "Placa sin código" : "Con código";
    return `
      <tr>
        <td>${e.fecha}</td>
        <td>${e.hora ?? "—"}</td>
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground", children: "Historial de Impresión" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            showPdfButton && historial.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
            ...
            historial.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: onClear,
        ...
        historial.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "No hay registros todavía. Genera un ZIP para ver el historial."
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", "data-ocid": "history.table", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-white/10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2 px-2 text-muted-foreground font-medium", children: "Fecha" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2 px-2 text-muted-foreground font-medium", children: "Hora" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2 px-2 text-muted-foreground font-medium", children: "Operario" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2 px-2 text-muted-foreground font-medium", children: "Tipo / Nombre" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2 px-2 text-muted-foreground font-medium", children: "Cód. Inicio" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2 px-2 text-muted-foreground font-medium", children: "Cód. Fin" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center py-2 px-2 text-muted-foreground font-medium", children: "Lotes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center py-2 px-2 text-muted-foreground font-medium", children: "Total" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2 px-2" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: historial.map((entry, i) => {
            const sinCodigo = entry.tipo === "sin-codigo";
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2 text-foreground", children: entry.fecha }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2 text-foreground", children: entry.hora ?? "—" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2 text-foreground", children: entry.operario ?? "—" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2 font-mono text-primary", children: sinCodigo ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "—" }) : entry.codigoInicio }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2 font-mono text-primary", children: sinCodigo ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "—" }) : entry.codigoFin }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2 text-center text-foreground", children: sinCodigo ? "—" : entry.lotes }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-2 text-center text-foreground", children: entry.totalImagenes }),
...
function nowTimeStr() {
  const now2 = /* @__PURE__ */ new Date();
  return now2.toTimeString().slice(0, 5);
}
function ManualPrintPage({
  historial,
  onManualAdd,
  onDelete,
  onClear,
  ...
  const [tipo, setTipo] = reactExports.useState("con-codigo");
  const [fecha, setFecha] = reactExports.useState(todayStr$1());
  const [hora, setHora] = reactExports.useState(nowTimeStr());
  const [operario, setOperario] = reactExports.useState("");
  const [codigoInicio, setCodigoInicio] = reactExports.useState("");
  const [codigoFin, setCodigoFin] = reactExports.useState("");
  const [lotes, setLotes] = reactExports.useState("");
  const [totalImagenes, setTotalImagenes] = reactExports.useState("");
  const [cantidad, setCantidad] = reactExports.useState("");
  const [nombre, setNombre] = reactExports.useState("");
  const [success, setSuccess] = reactExports.useState(false);
  const [placaPrompt, setPlacaPrompt] = reactExports.useState(null);
  function handleSubmit(e) {
    e.preventDefault();
    let entry;
    let cantidadNum = 0;
    if (tipo === "sin-codigo") {
      ...
      entry = {
        ...
        fecha,
        hora,
        operario: operario.trim() || void 0,
        tipo: "sin-codigo",
        nombre: nombre.trim() || void 0,
        codigoInicio: "",
        codigoFin: "",
        lotes: 0,
  ...
  const inputCls = "bg-background/40 border border-white/15 rounded-lg px-3 py-2 text-foreground text-sm font-mono focus:outline-none focus:ring-1 focus:ring-primary w-full placeholder:text-muted-foreground/55 transition-colors";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-5", children: "Registrar Impresión Manual" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground block mb-2", children: "Tipo de matrícula / placa" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    background: tipo === "con-codigo" ? "oklch(0.828 0.167 87)" : "oklch(0.175 0.038 241)",
                    color: tipo === "con-codigo" ? "oklch(0.138 0.032 243)" : "oklch(0.75 0.04 236)",
                    borderColor: tipo === "con-codigo" ? "oklch(0.828 0.167 87)" : "rgba(255,255,255,0.12)"
                  },
                  "data-ocid": "manual_print.tipo_con_codigo",
                  children: "🔲 Con código de barras"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: "flex-1 py-2.5 px-4 rounded-xl text-sm font-semibold transition-all border",
                  style: {
                    background: tipo === "sin-codigo" ? "oklch(0.696 0.17 162.48)" : "oklch(0.175 0.038 241)",
                    color: tipo === "sin-codigo" ? "oklch(0.138 0.032 243)" : "oklch(0.75 0.04 236)",
                    borderColor: tipo === "sin-codigo" ? "oklch(0.696 0.17 162.48)" : "rgba(255,255,255,0.12)"
                  },
                  "data-ocid": "manual_print.tipo_sin_codigo",
                  children: "📋 Sin código / Placa"
                }
              )
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, "data-ocid": "manual_print.modal", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Fecha" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "date",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Hora" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "time",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1.5 sm:col-span-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Operario" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "text",
              ...
              tipo === "con-codigo" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Código Inicio" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "text",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Código Fin" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "text",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Lotes" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "number",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Total Imágenes" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "number",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1.5 sm:col-span-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Nombre / Proveedor" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "text",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground/70", children: "Opcional. Identifica el proveedor o tipo de placa." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1.5 sm:col-span-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Cantidad de placas realizadas" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "number",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground/70", children: "Estas placas no tienen código de barras. En el PDF solo aparecerá la cantidad." })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { size: 15 }),
                    "Registrar Impresión"
                  ]
                }
              ),
              ...
              success && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: "✓ Impresión registrada"
                }
              )
            ] })
          ] }),
          placaPrompt && orders.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
...
function buildCode(prefix2, num, digits) {
  return prefix2 + String(num).padStart(digits, "0");
}
function getCamaCodeRange(order, qty) {
  if (!order.codigoInicio || order.tipo !== "matriculas") return null;
  const { prefix: prefix2, num, digits } = parseCode(order.codigoInicio);
  const camaStart = num + order.hecho;
  const camaEnd = camaStart + qty - 1;
  return {
    codigoInicio: buildCode(prefix2, camaStart, digits),
    codigoFin: buildCode(prefix2, camaEnd, digits)
  };
}
function Orders({
  orders,
  ...
  const [nombre, setNombre] = reactExports.useState("");
  const [editingCamaId, setEditingCamaId] = reactExports.useState(null);
  const [editingCamaVal, setEditingCamaVal] = reactExports.useState("");
  const editInputRef = reactExports.useRef(null);
  const [showModal, setShowModal] = reactExports.useState(false);
  const [modalTipo, setModalTipo] = reactExports.useState("matriculas");
  const [modalTotal, setModalTotal] = reactExports.useState(1e3);
  const [modalCodInicio, setModalCodInicio] = reactExports.useState("");
  const [modalResponsable, setModalResponsable] = reactExports.useState("");
  function handleAdd() {
    if (!nombre.trim()) return;
    setShowModal(true);
  }
  function handleModalConfirm() {
    let autoCodigoFin = void 0;
    if (modalTipo === "matriculas" && modalCodInicio) {
      const { prefix: prefix2, num, digits } = parseCode(modalCodInicio);
      autoCodigoFin = buildCode(prefix2, num + modalTotal - 1, digits);
    }
    onAdd(
      nombre.trim(),
      modalTotal,
      modalTipo,
      modalCodInicio || void 0,
      autoCodigoFin,
      modalResponsable.trim() || void 0
    );
    setNombre("");
    setModalTotal(1e3);
  ...
  function startEditCama(order) {
    setEditingCamaId(order.id);
    setEditingCamaVal(String(order.piezasPorCama ?? piezasPorCama));
    setTimeout(() => {
      var _a2;
      return (_a2 = editInputRef.current) == null ? void 0 : _a2.focus();
    }, 0);
  }
  function confirmEditCama(id) {
  ...
  function handleAddCama(order) {
    const qty = order.piezasPorCama ?? piezasPorCama;
    const now2 = /* @__PURE__ */ new Date();
    const fecha = now2.toLocaleDateString("es-ES");
    const hora = now2.toLocaleTimeString("es-ES", {
      hour: "2-digit",
      minute: "2-digit"
    });
    const tipoEntry = order.tipo === "matriculas" ? "con-codigo" : "sin-codigo";
    ...
    const entry = {
      ...
      hora,
      tipo: tipoEntry,
      nombre: order.tipo !== "matriculas" ? `${TIPO_LABELS$1[order.tipo ?? "matriculas"]} — ${order.nombre}` : `${order.nombre}`,
      codigoInicio: (codeRange == null ? void 0 : codeRange.codigoInicio) ?? order.codigoInicio ?? "",
      codigoFin: (codeRange == null ? void 0 : codeRange.codigoFin) ?? order.codigoFin ?? "",
      lotes: 1,
      totalImagenes: qty
    };
  ...
  const inputCls = "bg-background/40 border border-white/15 rounded-lg px-3 py-1.5 text-foreground text-sm focus:outline-none focus:ring-1 focus:ring-primary placeholder:text-muted-foreground/60";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-semibold text-sm text-foreground mb-4", children: [
                "Configurar pedido:",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.828 0.167 87)" }, children: nombre })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-2", children: "¿Qué tipo de pedido es?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["matriculas", "placas", "advertencia"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    ...
                    style: {
                      background: modalTipo === t ? TIPO_COLORS$1[t].bg : "oklch(0.175 0.038 242)",
                      color: modalTipo === t ? TIPO_COLORS$1[t].text : "oklch(0.72 0.038 236)",
                      border: modalTipo === t ? `1px solid ${TIPO_COLORS$1[t].text}` : "1px solid rgba(255,255,255,0.08)"
                    },
                    children: TIPO_LABELS$1[t]
                  },
                  t
                )) })
              ] }),
              modalTipo === "matriculas" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "label",
                    {
                      ...
                      children: "Código de inicio de la matrícula"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                ...
                modalCodInicio && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mb-0.5", children: "Código de fin calculado automáticamente:" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          className: "text-sm font-mono font-semibold",
                          ...
                          children: (() => {
                            const { prefix: prefix2, num, digits } = parseCode(modalCodInicio);
                            return buildCode(prefix2, num + modalTotal - 1, digits);
                          })()
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-1", children: "Cada +1 Cama añade 30 al historial continuando la secuencia." })
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "label",
                  {
                    htmlFor: "modal-total",
                    className: "text-xs text-muted-foreground block mb-1",
                    children: "Cantidad total a producir"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground mt-1", children: [
                  "Total de ",
                  TIPO_LABELS$1[modalTipo],
                  " a producir en este pedido"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "label",
                  {
                    ...
                    children: [
                      ...
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/50", children: "(opcional)" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4", children: "Pedidos Activos" }),
          ...
          orders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: "No hay pedidos. Agrega uno arriba."
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: orders.map((order, i) => {
            ...
            const tipoColors = TIPO_COLORS$1[order.tipo ?? "matriculas"];
            const nextRange = order.tipo === "matriculas" && order.codigoInicio && !done ? getCamaCodeRange(order, camaQty) : null;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm text-foreground", children: order.nombre }),
                      order.tipo && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: TIPO_LABELS$1[order.tipo]
                        }
                      ),
                      order.responsable && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "span",
                        {
                          className: "text-[10px] px-2 py-0.5 rounded-full font-medium",
                          style: {
                  ...
                  order.tipo === "matriculas" && order.codigoInicio && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 text-xs mb-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "font-mono",
                          style: { color: "oklch(0.828 0.167 87)" },
                          children: order.codigoInicio
                        }
                      )
                    ] }),
                    order.codigoFin && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                      "Fin:",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "font-mono",
                          style: { color: "oklch(0.828 0.167 87)" },
                          children: order.codigoFin
                        }
                      )
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 text-xs mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                      "Total:",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: order.total })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                      "Hecho:",
                      " ",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                      "Restante:",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: restante })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 rounded-full bg-white/10 mb-3 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "h-full rounded-full transition-all",
                      style: {
                        width: `${pct}%`,
                        background: done ? "oklch(0.696 0.17 162.48)" : "oklch(0.828 0.167 87)"
                      }
                    }
                  ) }),
                  nextRange && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        style: {
                          background: done ? "oklch(0.295 0.052 240)" : "oklch(0.828 0.167 87)",
                          color: done ? "oklch(0.652 0.048 236)" : "oklch(0.138 0.032 243)"
                        },
                    ...
                    editingCamaId === order.id ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ref: editInputRef,
                      ...
                      "button",
                      {
                        ...
                        children: [
                          ...
                          order.piezasPorCama !== void 0 ? `${order.piezasPorCama} pzs/cama` : "Personalizar"
                        ]
                      }
                    )
                  ] })
...
const cardBg = "linear-gradient(135deg, oklch(0.215 0.042 240), oklch(0.245 0.048 240))";
...
function PedidosEnviadosPage({
  ...
  const [nombre, setNombre] = reactExports.useState("");
  const [cantidad, setCantidad] = reactExports.useState(0);
  const [tipo, setTipo] = reactExports.useState("matriculas");
  const [notas, setNotas] = reactExports.useState("");
  function handleSubmit(e) {
    e.preventDefault();
    if (!nombre.trim() || cantidad <= 0) return;
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  className: "text-sm font-semibold",
                  style: { color: "oklch(0.942 0.012 236)" },
                  children: "Pedidos Enviados"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Registro de pedidos completados y enviados al cliente" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            pedidosEnviados.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  " enviados ·",
                  " ",
                  totalEnviadas.toLocaleString("es"),
                  " uds"
                ]
              }
            ),
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Nombre / Descripción *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Cantidad *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "number",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Tipo *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    value: tipo,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Notas (opcional)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    type: "text",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: "Guardar pedido enviado"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground", children: "Historial de enviados" }),
                pedidosEnviados.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
                  pedidosEnviados.length,
                  " registro",
          ...
          pedidosEnviados.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "No hay pedidos enviados todavía"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center max-w-xs", children: 'Usa el botón "Añadir enviado" o pídele al chat que añada uno cuando completes un pedido.' }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    ...
                    children: "Añadir primero enviado"
                  }
                )
              ]
            }
            ...
            "div",
            {
              ...
              children: pedidosEnviados.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-0.5 flex-wrap", children: [
                        ...
                        p.notas && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground truncate max-w-xs", children: [
                          "📝 ",
                          p.notas
                        ] })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 text-right mr-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: "text-base font-bold tabular-nums",
                          style: { color: TIPO_COLORS[p.tipo] },
                          children: p.cantidad.toLocaleString("es")
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: "unidades" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
...
function TutorialPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "rounded-2xl p-6",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                style: { color: "oklch(0.942 0.012 236)" },
                children: "Guía de uso"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Todo lo que necesitas saber para usar la app. Sin tecnicismos." })
          ] })
        ] })
      }
    ),
    steps.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "rounded-2xl p-6",
        style: {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-3", children: step.desc }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: step.items.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "oklch(0.828 0.167 87)" },
                children: "Consejo importante"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Todo se guarda automáticamente en tu navegador. No necesitas hacer nada especial para guardar. Si limpias el historial del navegador, perderás los datos. Si quieres hacer una copia de seguridad, descarga el PDF antes de borrar." })
          ] })
        ] })
      }
    )
...
function WeeklyGoal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4", children: "Objetivo Semanal" }),
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: { color: "oklch(0.828 0.167 87)" },
                    children: hecho.toLocaleString()
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: "Hecho" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold text-foreground", children: restante.toLocaleString() }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: "Restante" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: "Progreso" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 rounded-full bg-white/10 mb-4 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
          ...
          "div",
          {
            ...
            children: "Semana hecha ✅"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Objetivo semanal (piezas)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
...
function App() {
  const [activePage, setActivePage] = reactExports.useState("generador");
  ...
  const [pedidosEnviados, setPedidosEnviados] = useLocalStorage("pedidosEnviados", []);
  const [semanaData, setSemanaData] = useLocalStorage("semana", {
    week: getSemanaISO(/* @__PURE__ */ new Date()),
    hecho: 0
  });
  const [objetivo, setObjetivo] = useLocalStorage("objetivo", 5e3);
  const [piezasPorCama, setPiezasPorCama] = useLocalStorage(
    "piezasPorCama",
    30
  );
  reactExports.useEffect(() => {
    const currentWeek = getSemanaISO(/* @__PURE__ */ new Date());
    if (semanaData.week !== currentWeek) {
      setSemanaData({ week: currentWeek, hecho: 0 });
    }
  }, [semanaData.week, setSemanaData]);
  const handleAddCama = reactExports.useCallback(
    (orderId) => {
      setOrders(
        (prev) => prev.map((o) => {
          if (o.id !== orderId) return o;
          const qty2 = o.piezasPorCama ?? piezasPorCama;
          return { ...o, hecho: Math.min(o.total, o.hecho + qty2) };
        })
      );
      const order = orders.find((o) => o.id === orderId);
      const qty = (order == null ? void 0 : order.piezasPorCama) ?? piezasPorCama;
      setSemanaData((prev) => ({ ...prev, hecho: prev.hecho + qty }));
    },
    [piezasPorCama, orders, setOrders, setSemanaData]
  );
  function handleAddOrder(nombre, total, tipo, codigoInicio, codigoFin, responsable) {
    setOrders((prev) => [
      ...prev,
      {
        id: Date.now().toString(),
  ...
  function handleUpdateOrder(id, changes) {
    setOrders(
      (prev) => prev.map((o) => o.id === id ? { ...o, ...changes } : o)
    );
  }
  function handleAddToPedido(orderId, cantidad) {
    setOrders(
      (prev) => prev.map(
        (o) => o.id === orderId ? { ...o, hecho: Math.min(o.total, o.hecho + cantidad) } : o
      )
    );
    setSemanaData((prev) => ({ ...prev, hecho: prev.hecho + cantidad }));
  }
  function handleHistorialAdd(entry) {
    setHistorial((prev) => [entry, ...prev]);
  }
  function handleHistorialDelete(id) {
    setHistorial((prev) => prev.filter((e) => e.id !== id));
  }
  function updateConfig(field, value) {
    setConfig((prev) => ({ ...prev, [field]: value }));
  }
  function handleAddPedidoEnviado(p) {
    setPedidosEnviados((prev) => [p, ...prev]);
  }
  function handleDeletePedidoEnviado(id) {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "header",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between max-w-[1400px] mx-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-semibold text-sm text-foreground", children: "Barcode Manager" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Generador de Códigos de Barras" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-1", "aria-label": "Páginas", children: tabs.map((tab) => {
                const isActive = activePage === tab.id;
                const isTutorial = tab.id === "tutorial";
                const defaultAccent = isTutorial ? "oklch(0.8 0.12 270)" : "oklch(0.828 0.167 87)";
                const defaultAccentBg = isTutorial ? "oklch(0.7 0.15 270 / 0.12)" : "oklch(0.828 0.167 87 / 0.12)";
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          style: {
                            background: isActive ? accentColor : "oklch(0.295 0.052 240)",
                            color: isActive ? "oklch(0.138 0.032 243)" : "oklch(0.85 0.02 236)"
                          },
                          children: tab.num
                        }
                      ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground hidden sm:block", children: (/* @__PURE__ */ new Date()).toLocaleDateString("es-ES", {
                weekday: "long",
                year: "numeric",
                month: "long",
                day: "numeric"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "p-6", children: activePage === "generador" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-5 max-w-[1400px] mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-72 shrink-0 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "rounded-2xl p-5 shadow-card",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4", children: "Configuración de Código" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Código base" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          type: "text",
                          value: config.codigoBase,
                          onChange: (e) => updateConfig("codigoBase", e.target.value),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: [
                      ...
                      ["Texto X", "textX"],
                      ["Texto Y", "textY"]
                    ].map(([label, field]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          type: "number",
                          value: config[field],
                          onChange: (e) => updateConfig(field, Number(e.target.value)),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Tamaño de texto" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-3", children: "Producción" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Piezas por cama (global)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-4 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4", children: "Vista Previa" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(BarcodePreview, { config })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        ] }) : activePage === "registro" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ManualPrintPage,
          {
            historial,
        ...
        ) : activePage === "historial" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          HistorialPage,
          {
            historial,
            onDelete: handleHistorialDelete,
        ...
        ) : activePage === "chat" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChatPage,
          {
            historial,
            pedidos: orders,
        ...
        ) : activePage === "enviados" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          PedidosEnviadosPage,
          {
            pedidosEnviados,
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(TutorialPage, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "footer",
          {
