...
function BatchSystem({
  ...
  const [loteDesde, setLoteDesde] = reactExports.useState(1);
  const [loteHasta, setLoteHasta] = reactExports.useState(3);
  const [imgsPerLote, setImgsPerLote] = reactExports.useState(10);
  const [incremento, setIncremento] = reactExports.useState(30);
  ...
  const computedEndCode = (() => {
    ...
    if (!cantidadMatriculas.trim() || Number.isNaN(qty) || qty <= 0)
      return null;
    const { prefix: prefix2, num, digits } = parseCode$1(effectiveStartCode);
    return buildCode$1(prefix2, num + qty - 1, digits);
  })();
  ...
  async function handleGenerate() {
    ...
    try {
      const zip = new JSZip();
      const { prefix: prefix2, num: startNum, digits } = parseCode$1(effectiveStartCode);
      ...
      if (useQuantityMode) {
        ...
        while (remaining > 0) {
          ...
          for (let i = 0; i < batchSize; i++) {
            const code = buildCode$1(prefix2, currentNum, digits);
      ...
      a.click();
      URL.revokeObjectURL(url);
      const lotesGenerados = useQuantityMode ? Math.ceil(Number.parseInt(cantidadMatriculas, 10) / imgsPerLote) : loteHasta - loteDesde + 1;
      onHistorialAdd({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4", children: "Sistema de Lotes" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Código de inicio" }),
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground mb-0.5", children: "Secuencia calculada" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground block mb-0.5", children: "Total" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
        ...
        !useQuantityMode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Lote desde" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Lote hasta" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Imgs por lote" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Incremento por lote" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "number",
        ...
        useQuantityMode && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: generating ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              useQuantityMode ? `Generar ${cantidadMatriculas} matrículas` : "Generar ZIP"
            ] })
          }
        )
      ]
...
function downloadBarcodePdf(entry, customStart, customEnd) {
  ...
  const { prefix: prefix2, num: startNum, digits } = parseCode(startCode);
  ...
  for (let i = 0; i < count; i++) {
    codes.push(buildCode(prefix2, startNum + i, digits));
  }
  const meta = `Operario: ${entry.operario ?? "—"} | Desde: ${startCode} | Hasta: ${buildCode(prefix2, startNum + count - 1, digits)} | Total: ${count} códigos`;
...
function downloadSelectedPdf(selectedEntries) {
  ...
  for (const { entry } of conCodigo) {
    const { prefix: prefix2, num: startNum, digits } = parseCode(entry.codigoInicio);
    for (let i = 0; i < entry.totalImagenes; i++) {
      allCodes.push(buildCode(prefix2, startNum + i, digits));
    }
  }
...
function ManualPrintPage({
  ...
  const inputCls = "bg-background/40 border border-white/10 rounded-lg px-3 py-2 text-foreground text-sm font-mono focus:outline-none focus:ring-1 focus:ring-primary w-full placeholder:text-muted-foreground/50 transition-colors";
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...
                    color: tipo === "con-codigo" ? "oklch(0.138 0.032 243)" : "oklch(0.652 0.048 236)",
                    borderColor: tipo === "con-codigo" ? "oklch(0.828 0.167 87)" : "rgba(255,255,255,0.1)"
                  },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    ...
                    color: tipo === "sin-codigo" ? "oklch(0.138 0.032 243)" : "oklch(0.652 0.048 236)",
                    borderColor: tipo === "sin-codigo" ? "oklch(0.696 0.17 162.48)" : "rgba(255,255,255,0.1)"
                  },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5", children: [
              ...
              tipo === "con-codigo" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1.5 sm:col-span-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground/60", children: "Opcional. Identifica el proveedor o tipo de placa." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1.5 sm:col-span-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground/60", children: "Estas placas no tienen código de barras. En el PDF solo aparecerá la cantidad." })
                ] })
              ] })
            ] }),
...
function Orders({
  ...
  const [nombre, setNombre] = reactExports.useState("");
  const [total, setTotal] = reactExports.useState(1e3);
  function handleAdd() {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 text-xs mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                    "Total:",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: order.total })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                    "Hecho:",
                    " ",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                    "Restante:",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: restante })
                  ] })
                ] }),
...
function App() {
  ...
  const handleAddCama = reactExports.useCallback(
    (orderId) => {
      setOrders(
        (prev) => prev.map(
          (o) => o.id === orderId ? { ...o, hecho: Math.min(o.total, o.hecho + piezasPorCama) } : o
        )
      );
  ...
  function handleAddOrder(nombre, total) {
    setOrders((prev) => [
      ...prev,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-1", "aria-label": "Páginas", children: tabs.map((tab) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    style: {
                      background: isActive ? "oklch(0.828 0.167 87 / 0.12)" : "transparent",
                      color: isActive ? "oklch(0.828 0.167 87)" : "oklch(0.652 0.048 236)",
                      borderBottom: isActive ? "2px solid oklch(0.828 0.167 87)" : "2px solid transparent"
                    },
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          style: {
                            background: isActive ? "oklch(0.828 0.167 87)" : "oklch(0.295 0.052 240)",
                            color: isActive ? "oklch(0.138 0.032 243)" : "oklch(0.652 0.048 236)"
                          },
                          children: tab.num
                        }
                      ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-72 shrink-0 space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-3", children: "Configuración de Producción" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex flex-col gap-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Piezas por cama" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        type: "number",
