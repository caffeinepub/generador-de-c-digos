...
Pulsa el botón para confirmarlo.`,
  ...
  const generalPdf = !pdfMatch && (msg.includes("pdf") || msg.includes("descargar") || msg.includes("imprimir"));
  if (resumPdf) {
    return {
...
Asegúrate de que el código de inicio o fin de los registros empiece por "${seriesPrefix}". Puedes pedir "resumen del historial" para ver todos los registros.`
    ...
    const lastCode2 = getLastCodeInSeries(matched);
...
📍 Último código de la serie: **${lastCode2 ?? "—"}**`
    };
  }
...
const WELCOME_MSG = "¡Hola! Soy tu asistente de producción 🤖. Puedes preguntarme cosas como: ¿por qué matrícula de TAS me quedé?, ¿resumen del historial?, ¿cuántas matrículas hice?, ¿qué pedidos tengo activos? También puedo generar PDFs y añadir pedidos enviados.";
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Pregúntame sobre códigos, pedidos, historial, genera PDFs o añade pedidos enviados" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
